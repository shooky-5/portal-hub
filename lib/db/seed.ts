...
async function seedApps() {
  ...
  const apps = [
    ...
    },
    {
      id: 'compass',
      name: 'Compass',
      full: 'Compass Intelligence Navigator',
      desc: 'Navigate complex analytical landscapes with structured methodologies.',
